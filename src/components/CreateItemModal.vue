                        ...
                        <div class="cn-modal__block">
                            <div class="cn-modal__main">
                                ...
                                <div class="cn-modal__content">
                                    <single-line name="name" label="Item Name" @updateValue="updateValue"/>
                                    <number-mode name="price" label="Price" @updateValue="updateValue"/>
                                    <select-mode name="type" label="type" :options="getoptions" @updateValue="updateValue"/>
                                </div>
                            </div>
                            <div class="cn-modal__aside">
                                ...
                                <div class="cn-modal__actions cn-mar--t-md">
                                    <div class="cn-modal__action">
                                        ...
                                        <input type="button" class="cn-btn cn-btn--raised cn-btn--primary cn-btn--action" value="Create" @click="next()" :class="{'cn-btn--spinner': showLoader}">
                                    </div>
                                    <div class="cn-modal__action">
